		...
		.tap(async (pb) =>
		{
			...
			return Bluebird.resolve(pb)
				.tap(async (pb) =>
				{
					...
					await page.goto('http://lotto.arclink.com.tw/Lotto388jhdz.html', defaultGoToOptions);
//	await page.goto('https://www.taiwanlottery.com.tw/lotto/superlotto638/history2.aspx');
					...
					await pb.newPage()
						.then(async (page) => {
							...
							await page.goto(`http://lotto.arclink.com.tw/jsp/lotto/historyKind120100.jsp?n1=&n2=&n3=`, defaultGoToOptions);
